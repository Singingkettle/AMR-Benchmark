...
def CNN2Model(weights=None,
    ...
    model.add(
        Convolution2D(50, (1, 8), padding='same', activation="relu", name="conv1", kernel_initializer='glorot_uniform'))
    model.add(Dropout(dr))
    model.add(Convolution2D(50, (2, 8), padding="valid", activation="relu", name="conv2",
