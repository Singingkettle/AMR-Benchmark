...
model = culstm.CuDNNLSTMModel(weights=None, input_shape=[128, 2], classes=10)
...
def predict(model):
    ...
    mltools.plot_confusion_matrix(confnorm,
                                  labels=['8PSK', 'AM-DSB', 'BPSK', 'CPFSK', 'GFSK', 'PAM4', 'QAM16', 'QAM64', 'QPSK',
                                          'WBFM'], save_filename='figure/lstm3_total_confusion.png')
    ...
    for snr in snrs:
        ...
        mltools.plot_confusion_matrix(confnorm_i,
                                      labels=['8PSK', 'AM-DSB', 'BPSK', 'CPFSK', 'GFSK', 'PAM4', 'QAM16', 'QAM64',
