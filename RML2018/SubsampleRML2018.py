...
def sliceX_normalized(from_filename='/media/GOLD_XYZ_OSC.0001_1024.hdf5', slice_len=1024,
    ...
    for i in range(int(X.shape[0] / batch_size)):
        ...
        batch_X = X[i * batch_size:(i + 1) * batch_size, 0:slice_len,
                  :]  # batch_sample{ndarray[batch_size,slice_len,2],ndarray[4096,512,2]}
...
#   采样数据，分块随机打乱顺序，保存成文件
def subsample_data_2018_tofile(from_filename="/media/XYZ_1024_2m_norm.hdf5", sample_rate=1 / 12,
...
if __name__ == '__main__':
    subsample_data_2018_tofile(from_filename=r"\GOLD_XYZ_OSC.0001_1024.hdf5", sample_rate=1 / 12,
